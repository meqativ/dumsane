...
massive = {
	settings: {
		...
		clearUsersLabel: {
			...
			uk: (amount) => `Ви маєте ${amount} користувач${slavicNoun(amount, "а", "а", "ів")} у списку ігнорованих користувачів`,
			ru: (amount) => `Вы имеете ${amount} пользовател${slavicNoun(amount, "я", "я", "ей")} в списке игнорированных пользователей`,
		},
		...
		confirmClear: {
			...
			description: {
				...
				uk: (amount) => `Це прибере ${amount} користувач${slavicNoun(amount, "а", "а", "ів")} зі списку ігнорованих користувачів.\nВи дійсно хочете продовжити?`,
				ru: (amount) => `Это уберет ${amount} пользовател${slavicNoun(amount, "я", "я", "ей")} из списка игнорированных пользователей.\nВы действительно хотите продолжить?`,
			},
			yes: {
				"en-GB": "Yes",
				uk: "Так",
